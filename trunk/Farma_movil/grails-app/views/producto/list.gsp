                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="description" title="${message(code: 'producto.description.label', default: 'Description')}" />
                    ...
                    <g:each in="${productoInstanceList}" status="i" var="productoInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: productoInstance, field: "cantidad")}</td>
                        
                            <td>${fieldValue(bean: productoInstance, field: "description")}</td>
