                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="distrito" title="${message(code: 'user.distrito.label', default: 'Distrito')}" />
                        
                            <g:sortableColumn property="dni" title="${message(code: 'user.dni.label', default: 'Dni')}" />
                        
                            <g:sortableColumn property="email" title="${message(code: 'user.email.label', default: 'Email')}" />
                        
                            <g:sortableColumn property="flagNotif" title="${message(code: 'user.flagNotif.label', default: 'Flag Notif')}" />
                    ...
                    <g:each in="${userInstanceList}" status="i" var="userInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: userInstance, field: "distrito")}</td>
                        
                            <td>${fieldValue(bean: userInstance, field: "dni")}</td>
                        
                            <td>${fieldValue(bean: userInstance, field: "email")}</td>
                        
                            <td>${fieldValue(bean: userInstance, field: "flagNotif")}</td>
