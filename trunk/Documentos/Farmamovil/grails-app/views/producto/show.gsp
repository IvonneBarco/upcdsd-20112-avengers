	...
	<body>
		...
		<div id="show-producto" class="content scaffold-show" role="main">
			...
			<ol class="property-list producto">
				...
				<g:if test="${productoInstance?.description}">
				<li class="fieldcontain">
					<span id="description-label" class="property-label"><g:message code="producto.description.label" default="Description" /></span>
					
						<span class="property-value" aria-labelledby="description-label"><g:fieldValue bean="${productoInstance}" field="description"/></span>
