...
class ProductoController {
    ...
    def list = {
		...
		print Producto.list(params)
		
		if (Producto.count()==0)
		withHttp(uri: "http://localhost:8082") {
		   def html = get(path : '/wsfarma/rest/clienteRest/producto')
		   
		   html.each{
		   print it.codigo
				def event10 = new Producto(code2:it.codigo,description:it.descripcion,cantidad:it.precio).save()
		   }
		}	
